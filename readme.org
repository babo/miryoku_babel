...
<<table-layer-taphold(alphas_table=aptmak, thumbs_table=thumbs-flip, hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_BASE_APTV3_FLIP \
<<table-layer-taphold(alphas_table=aptv3, thumbs_table=thumbs-flip, hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_BASE_APTV5_FLIP \
<<table-layer-taphold(alphas_table=aptv5, thumbs_table=thumbs-flip, hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_BASE_BIRD_FLIP \
<<table-layer-taphold(alphas_table=bird, thumbs_table=thumbs-flip, hold_table=hold-flip)>>

#define MIRYOKU_ALTERNATIVES_BASE_GALLIUM_FLIP \
<<table-layer-taphold(alphas_table=gallium, thumbs_table=thumbs-flip, hold_table=hold-flip)>>
...
<<table-layer-taphold(alphas_table=aptmak)>>

#define MIRYOKU_ALTERNATIVES_BASE_APTV3 \
<<table-layer-taphold(alphas_table=aptv3)>>

#define MIRYOKU_ALTERNATIVES_BASE_APTV5 \
<<table-layer-taphold(alphas_table=aptv5)>>

#define MIRYOKU_ALTERNATIVES_BASE_BIRD \
<<table-layer-taphold(alphas_table=bird)>>

#define MIRYOKU_ALTERNATIVES_BASE_GALLIUM \
<<table-layer-taphold(alphas_table=gallium)>>
...
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptmak, thumbs_table=thumbs-flip)>>

#define MIRYOKU_ALTERNATIVES_TAP_APTV3_FLIP \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptv3, thumbs_table=thumbs-flip)>>

#define MIRYOKU_ALTERNATIVES_TAP_APTV5_FLIP \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptv5, thumbs_table=thumbs-flip)>>

#define MIRYOKU_ALTERNATIVES_TAP_BIRD_FLIP \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=bird, thumbs_table=thumbs-flip)>>

#define MIRYOKU_ALTERNATIVES_TAP_GALLIUM_FLIP \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=gallium, thumbs_table=thumbs-flip)>>
...
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptmak, thumbs_table=thumbs)>>

#define MIRYOKU_ALTERNATIVES_TAP_APTV3 \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptv3, thumbs_table=thumbs)>>

#define MIRYOKU_ALTERNATIVES_TAP_APTV5 \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=aptv5, thumbs_table=thumbs)>>

#define MIRYOKU_ALTERNATIVES_TAP_BIRD \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=bird, thumbs_table=thumbs)>>

#define MIRYOKU_ALTERNATIVES_TAP_GALLIUM \
<<table-layer-full(current_layer_name="U_TAP", alphas_table=gallium, thumbs_table=thumbs)>>
